...
ITEMS = [
    ...
    ("W02", "range_widen_existing", "Low-pass filter at 0.01 Hz to smooth a very slow 3.3 V sensor signal.", R("low_pass_filter", {"cutoff_hz": 0.01}, {"supply_v": 3.3}), False),
    ("W03", "range_widen_existing", "Divide 400 V down to 3 V for my ADC.", R("voltage_divider", {"vout_v": 3.0}, {"supply_v": 400.0}), False),
    ("W04", "range_widen_existing", "Voltage divider giving 23.9 V from a 24 V rail.", R("voltage_divider", {"vout_v": 23.9}, {"supply_v": 24.0}), False),
    ...
    ("W10", "range_widen_existing", "A 10 mV reference from a 5 V rail using a resistor divider.", R("voltage_divider", {"vout_v": 0.01}, {"supply_v": 5.0}), False),
